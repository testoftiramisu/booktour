...
public class TourRatingControllerTest {
  ...
  public void createManyTourRatings() throws Exception {
    restTemplate.postForEntity(
        TOUR_RATINGS_URL + "/" + SCORE + "?customers=" + CUSTOMER_ID, ratingDto, Void.class);
  ...
  /**
   * RestTemplate Patch only works if it uses httpclient. Method will only work if: 1. Include
   * dependency <dependency> <groupId>org.apache.httpcomponents</groupId>
   * <artifactId>httpclient</artifactId> <version>4.4.1</version> </dependency> 2. Attach httpclient
